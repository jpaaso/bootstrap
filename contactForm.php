...
if (!isset($_POST['save']) || $_POST['save'] != 'Send your message') {
	header('Location: index.html#OtaYhteytta'); exit;
}
...
mail ("juho.paaso@gmail.com", "New Contact Message", $email_content);

// send the user back to the form
header('Location: index.html#OtaYhteytta?s='.urlencode('Thank you for your message.')); exit;
?>